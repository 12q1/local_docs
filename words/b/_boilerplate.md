...
- **Syndicated material.**
- **Standard text or program [[c/_code|code]] used routinely and [[a/_added|added]] with a text editor or word processor; text of a legal or official nature [[a/_added|added]] to documents or labels.**
...
- [[boilerplate code]]
#verb
- **To store (standard text) so that it [[c/_can|can]] easily be retrieved for reuse.**
---
#adjective
