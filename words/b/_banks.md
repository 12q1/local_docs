...
- **The sum of money etc. which the [[d/_dealer|dealer]] or [[b/_banker|banker]] has as a fund from which to draw stakes and pay losses.**
- **Money; profit**
- **In [[c/_certain|certain]] games, such as dominos, a fund of pieces from which the players are [[a/_allowed|allowed]] to draw.**
- **A safe and guaranteed place of storage for and retrieval of important items or goods.**
	- _Example: blood bank; sperm bank; data bank_
- **A device used to store [[c/_coins|coins]] or [[c/_currency|currency]].**
...
- **An elevation, or rising ground, under the sea; a shallow [[a/_area|area]] of shifting sand, gravel, mud, and so forth (for example, a sandbank or mudbank).**
	- _Example: the banks of Newfoundland_
- **A slope of earth, sand, etc.; an embankment.**
- **The incline of an [[a/_aircraft|aircraft]], especially during a turn.**
- **An incline, a hill.**
...
- **To [[c/_cover|cover]] the embers of a fire with [[a/_ashes|ashes]] in order to retain heat.**
- **To raise a mound or dike [[a/_about|about]]; to enclose, [[d/_defend|defend]], or fortify with a [[b/_bank|bank]]; to embank.**
...
- **A [[c/_contiguous|contiguous]] [[b/_block|block]] of memory that is of fixed, hardware-[[d/_dependent|dependent]] size, but often larger than a page and partitioning the memory such that two distinct [[b/_banks|banks]] do not overlap.**
- **A set of multiple [[a/_adjacent|adjacent]] drop targets.**
---
### Synonyms
...
- **The regular term of a [[c/_court|court]] of law, or the full [[c/_court|court]] sitting to hear [[a/_arguments|arguments]] upon questions of law, as distinguished from a sitting at nisi prius, or a [[c/_court|court]] held for jury trials. See [[b/_banc|banc]].**
