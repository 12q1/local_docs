...
- **A [[binary]] map in a given group G, given by [g, h] = ghg−1h−1, where g and h are elements of G, which yields the group's identity if and only if the group operation [[commutes]] for g and h.**
