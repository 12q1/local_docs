...
---
#noun
- **An [[a/_actual|actual]] event, situation, or fact.**
	- _Example: For a change, in this case, he was telling the truth._
- **A given [[c/_condition|condition]] or state.**
...
- **([[a/_academia|academia]]) An instance or event as a topic of study.**
	- _Example: The teaching consists of theory lessons and case studies._
- **A legal proceeding, lawsuit.**
- **(grammar) A specific inflection of a word [[d/_depending|depending]] on its function in the sentence.**
	- _Example: The accusative case canonically indicates a direct object.  Latin has six cases, and remnants of a seventh._
- **(grammar) Grammatical [[c/_cases|cases]] and their meanings taken [[e/_either|either]] as a topic in general or within a specific language.**
	- _Example: Jane has been studying case in Caucasian languages.  Latin is a language that employs case._
- **An instance of a specific [[c/_condition|condition]] or set of symptoms.**
	- _Example: There were another five cases reported overnight._
- **A section of [[c/_code|code]] representing one of the [[a/_actions|actions]] of a [[c/_conditional|conditional]] switch.**
---
#verb
- **To propose hypothetical [[c/_cases|cases]].**
---
#noun
- **A [[b/_box|box]] that [[c/_contains|contains]] or [[c/_can|can]] [[c/_contain|contain]] a number of identical items of manufacture.**
- **A [[b/_box|box]], sheath, or [[c/_covering|covering]] generally.**
	- _Example: a case for spectacles; the case of a watch_
- **A piece of luggage that [[c/_can|can]] be used to transport an [[a/_apparatus|apparatus]] such as a sewing machine.**
- **An [[e/_enclosing|enclosing]] frame or [[c/_casing|casing]].**
	- _Example: a door case; a window case_
- **A suitcase.**
- **A piece of furniture, [[c/_constructed|constructed]] partially of transparent glass or plastic, within which items [[c/_can|can]] be [[d/_displayed|displayed]].**
- **The outer [[c/_covering|covering]] or framework of a piece of [[a/_apparatus|apparatus]] such as a [[c/_computer|computer]].**
