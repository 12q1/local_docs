...
- **Short for [[c/_cardinal|cardinal]] number, a number indicating quantity, or the size of a set (e.g., zero, one, two, three). (See Wikipedia [[a/_article|article]] on [[c/_cardinal|Cardinal]] number.)**
...
---
#adjective
- **Of fundamental importance; [[c/_crucial|crucial]], pivotal.**
	- _Example: a cardinal rule_
- **Of or relating to the [[c/_cardinal|cardinal]] directions (north, south, east and west).**
	- _Example: a cardinal mark_
- **[[d/_describing|Describing]] a "natural" number used to indicate quantity (e.g., zero, one, two, three), as opposed to an ordinal number indicating relative position.**
- **Having a [[b/_bright|bright]] red [[c/_color|color]] (from the [[c/_color|color]] of a [[c/_catholic|Catholic]] [[c/_cardinal|cardinal]]'s [[c/_cassock|cassock]]).**
---
---
