...
- **A landform at the mouth of a river where it [[e/_empties|empties]] into a [[b/_body|body]] of water.**
...
- **The symbol Δ.**
- **A small but noticeable [[e/_effect|effect]]. [[c/_compare|Compare]] [[e/_epsilon|epsilon]].**
	- _Example: This will slow the main code path down, but only by delta._
- **The set of [[d/_differences|differences]] [[b/_between|between]] two versions of a file.**
	- _Example: When you update the file, the system will only save the deltas._
- **A [[c/_change|change]] in a quantity, likely from "[[d/_d|d]]" for "[[d/_difference|difference]]".**
